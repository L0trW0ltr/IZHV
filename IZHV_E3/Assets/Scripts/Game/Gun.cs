...
public class Gun : MonoBehaviour
{
    ...
    public void ShootGun(Transform director)
    {
        ...
        if (!shotgun)
        {
            // Fire one bullet in the director's direction
        ...
        else
        {
            ...
            for (int i = 0; i < shotgunBullets; i++)
            {
                ...
                // Create a new rotation of the bullet based on directors rotation
                Quaternion spreadRotation = director.rotation * Quaternion.Euler(0, 0, spreadAngle);
