...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            // Calculate the enemy direction to the player
            ...
            mRigidBody.MovePosition(newPosition); // Time.fixedDeltaTime represents the time interval between calls to the FixedUpdate method
        }
    }
