        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    bool toggleBool = GameManager.Instance.interactiveMode;
                    toggleBool = GUILayout.Toggle(toggleBool, " Enabled");
                    GameManager.Instance.interactiveMode = toggleBool;
                }
                GUILayout.EndHorizontal();
                ...
                {   	
                    ...
                    if (GUILayout.Button(SoundManager.Instance.masterMuted ? "Unmute" : "Mute", GUILayout.Height(20)))
                    {
